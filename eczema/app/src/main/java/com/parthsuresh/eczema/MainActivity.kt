package com.parthsuresh.eczema
...
import com.parthsuresh.eczema.classifier.*
import com.parthsuresh.eczema.classifier.tensorflow.ImageClassifierFactory
import com.parthsuresh.eczema.utils.getCroppedBitmap
import com.parthsuresh.eczema.utils.getUriFromFilePath
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showResult(result: Result) {
        if (result.result == "atopic") {
            textResult.text = "Atopic Dermatitis";
            textDiet.text = getString(R.string.atopic);
        } else if (result.result == "contact") {
            textResult.text = "Contact Dermatitis";
            textDiet.text = getString(R.string.contact);
        } else if (result.result == "dyshidrotic") {
            textResult.text = "Dyshidrotic Eczema";
            textDiet.text = getString(R.string.dyshidrotic);
        } else if (result.result == "hand") {
            textResult.text = "Hand Eczema";
            textDiet.text = getString(R.string.hand);
        } else if (result.result == "neuro") {
            textResult.text = "Neurodermatitis";
            textDiet.text = getString(R.string.neuro);
        } else if (result.result == "nummular") {
            textResult.text = "Nummular Eczema";
            textDiet.text = getString(R.string.nummular);
        } else if (result.result == "stasis") {
            textResult.text = "Stasis Dermatitis";
            textDiet.text = getString(R.string.stasis);
        }
    }
